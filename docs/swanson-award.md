...
Brandi Pessman, the 2025 recipient of the David Swanson award, from the University of Nebraska—Lincoln, attended the OSG User School in 2023. Her research involved a comparison of the web-construction behavior of funnel-weaving spiders in response to noise levels. Left with an amount of video data that would have taken too long to analyze manually, Brandi tried a few options before eventually discovering the OSG User School. Using the techniques she learned there, she created a training dataset that could identify and track the spider's location. She [presented on](https://agenda.hep.wisc.edu/event/2297/contributions/33499/) her research at HTC25.

Cort Posnansky, the 2024 recipient of the David Swanson award, is a member of the LIGO-Virgo-KAGRA Collaboration (LVK). He was able to take what he learned from attending the OSG User School and apply it to this collaboration, one which, he noted, requires high throughput computing by nature, as the aim is to find new waves from astrophysical collisions. He [spoke about](https://agenda.hep.wisc.edu/event/2175/contributions/31164/) his research at HTC24.
...
Aashish Tripathee, one of two recipients of the David Swanson award in 2023, is a Physics post-doctoral research fellow at the University of Michigan. He was able to apply the lessons learned at the OSG School to his research, where, upon switching to using the OSDF, he saw significant improvements in job transfer success rate. He [presented on](https://agenda.hep.wisc.edu/event/2014/contributions/28462/) his research at HTC23.
